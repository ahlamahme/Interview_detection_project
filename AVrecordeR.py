...
class VideoRecorder():
	...
	def __init__(self):
		...
		self.video_filename = "records/temp_video.avi"
...
class AudioRecorder():
    ...
    def __init__(self):
        ...
        self.audio_filename = "records/temp_audio.wav"
...
def file_manager(filename):
	...
	if os.path.exists(str(local_path) + "records/temp_audio.wav"):
		os.remove(str(local_path) + "records/temp_audio.wav")
	
	if os.path.exists(str(local_path) + "records/temp_video.avi"):
		os.remove(str(local_path) + "records/temp_video.avi")

	if os.path.exists(str(local_path) + "records/temp_video2.avi"):
		os.remove(str(local_path) + "records/temp_video2.avi")
